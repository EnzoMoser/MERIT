...
% Generate imaging domain
 [points, axes_,] = merit.domain.hemisphere(radius= 7e-2, resolution=2.5e-3, no_z=true); %% this is getting replaced with a function to just do 2d
 %[points, x_dists, y_dists, xs, ys] = merit.domain.get_pix_xys(500, 8);
